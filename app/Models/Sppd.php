...
class Sppd extends Model
{
    ...
    {
        return $this->hasMany(Rincian::class, 'sppd_id');
    }
    public function laporan()
    {
        return $this->hasMany(Laporan::class, 'sppd_id');
    }
    public function tanggalkwitansi()
    {
        return $this->hasMany(Tanggalkwitansi::class, 'sppd_id');
    }
    public function tanggalrincian()
    {
        return $this->hasMany(Tanggalrincian::class, 'sppd_id');
    }
