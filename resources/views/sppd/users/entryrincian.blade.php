            ...
            <div class="tab-content bg-light rounded-lg shadow p-4" id="v-pills-tabContent">
                ...
                <form method="POST" action="{{ Route('Rincian') }}/{{ $sppd->id }}/Entry">
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="Maksud" placeholder="Ketikkan Jumlah Biaya yang dibutuhkan per Hari.." required name="Jumlah_Per_Hari" value="">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row d-flex align-items-center">
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="Keterangan" placeholder="Ketikkan Keterangan Tambahan Penggunaan Biaya .." required name="Keterangan" value="">
                        </div>
                    </div>
