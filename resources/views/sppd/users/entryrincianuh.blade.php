    ...
    <div class="row row-cols-10 shadow rounded-lg p-3 justify-content-center m-0"
        ...
        <div class="col-9">
            ...
            <div class="tab-content bg-light rounded-lg shadow p-4" id="v-pills-tabContent">
                ...
                @endif
                <h3 class="text-center">Surat Perintah Tugas (SPT) <br> Surat Perintah Perjalanan Dinas (SPPD) <br> Rincian Perjalanan Dinas <br> Uang Harian (Wajib) </h3> 
                <hr>
                ...
                @endif
                <form method="POST" action="{{ Route('Rincian') }}/{{ $sppd->id }}/Entry">
                    @csrf
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="Maksud" placeholder="Ketikkan Maksud Kegunaan Biaya.." required name="Kegunaan_Biaya" required readonly value="Uang Harian">
                        </div>
                    </div>
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="Maksud" placeholder="Ketikkan Jumlah Biaya yang dibutuhkan per Hari.." required name="Jumlah_Per_Hari" required readonly value="{{ $uangharian->uang_harian }}">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-4">
                            <input type="date" class="form-control justify-content @error('tanggal_penggunaan') is-invalid @enderror" id="Tgl_penggunaan" placeholder="Tanggal Penggunaan.." required name="Tanggal_Penggunaan" >
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-4">
                            <input type="date" class="form-control justify-content @error('tanggal_selesai') is-invalid @enderror" id="Tgl_kembali" placeholder="Tanggal" required name="Tanggal_Selesai">
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="Keterangan" placeholder="Ketikkan Keterangan Tambahan Penggunaan Biaya .." required name="Keterangan" required readonly value="Uang Harian">
                        </div>
                    </div>
                    <button type="submit" class="btn btn-warning btn-md float-right">TAMBAH DATA</button>
                </form>
                    @if ($rincian != null)
