    ...
    <div class="row row-cols-10 shadow rounded-lg p-3 justify-content-center m-0" style="background-color: rgb(0, 183, 255)">
        ...
        <div class="col-9">
            ...
            <div class="tab-content bg-light rounded-lg shadow p-4" id="v-pills-tabContent">
                ...
                <form method="POST" action="{{ Route('Laporan') }}/{{ $sppd->id }}/Entry">
                    @csrf
                    <hr>
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class=" d-flex col-7 justify-content-center">
                            <textarea class="form-control justify-content" id="" placeholder="" required name="Petunjuk" value=""></textarea>
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class=" d-flex col-7 justify-content-center">
                            <input type="text" class="form-control justify-content" id="" placeholder="" required name="Masalah" value="">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class=" d-flex col-7 justify-content-center">
                            <input type="text" class="form-control justify-content" id="" placeholder="" required name="Saran" value="">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class=" d-flex col-7 justify-content-center">
                            <input type="text" class="form-control justify-content" id="" placeholder="" name="Lain" value="">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class=" d-flex col-7 justify-content-center">
                            <input type="text" class="form-control justify-content" id="" placeholder="" required name="Tglcetak" value="">
                        </div>
                    </div>
                    <hr>

                    <a class="btn btn-primary btn-md float-left" href="{{ Route('SPPD') }}/{{ $sppd->id }}/SPPD">Kembali <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                          <path fill-rule="evenodd" d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-4.5.5a.5.5 0 0 0 0-1H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5z"/>
                        </svg></a>


                    <button type="submit" class="btn btn-primary btn-md float-right">Input Data <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
