...
<!-- button kembali -->
        <tr>
            <td width="135px">
            <a href="{{ Route('Tanggalkwitansi') }}/{{ $sppd->id }}"class="btn btn-primary" style="font-size: 15px">Kembali <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="tab-content bg-light rounded-lg shadow p-4" id="v-pills-tabContent">
                ...
                @endif
                <h3 class="text-center">Input Tanggal Kwitansi<br></h3>

                <form method="POST" action="{{ Route('Tanggalkwitansi') }}/{{ $sppd->id }}/Entry">
                    @csrf
                    <hr>
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class=" d-flex col-7 justify-content-center">
                            <input type="text" class="form-control justify-content" id="" placeholder="" required name="Tglbendahara" value="">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class=" d-flex col-7 justify-content-center">
                            <input type="text" class="form-control justify-content" id="" placeholder="" required name="Tglyangmenerima" value="">
                        </div>
                    </div>
                    <hr>
